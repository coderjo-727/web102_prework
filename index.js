...
function addGamesToPage(games) {
    ...
    // loop over each item in the data
        ...
        for (let i = 0; i < games.length; i++) {
            ...
            div.innerHTML = `<p>${games[i].name} </p> <p> Game description: ${games[i].description} </p> <img src = "${games[i].img}" class = "game-img"/>`;
...
const displayStr = 
    `A total of $${totalContributions.toLocaleString('en-US')} has been raised for ${GAMES_JSON.length} games. Currently ${numUnfunded} ${numGames == 1 ? "game remains": "games remain"} unfunded. We need your help to fund these amazing games!`
